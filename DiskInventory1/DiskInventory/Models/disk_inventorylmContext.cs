...
{
    public partial class disk_inventorylmContext : DbContext
    {
        public disk_inventorylmContext()
        {
        }

        public disk_inventorylmContext(DbContextOptions<disk_inventorylmContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DiskHasArtist>(entity =>
            {
                entity.HasKey(e => new { e.DiskId, e.ArtistId })
                    .HasName("PK__disk_has__2DAE42F0ED810BF7");
            ...
            {
                //entity.HasKey(e => new { e.BorrowerId, e.DiskId, e.BorrowedDate })            // Project 4 changed key on table
                //    .HasName("PK__disk_has__3C6789B58AB259FD");                               // Project 4 changed key on table

                entity.ToTable("disk_has_borrower");

                entity.Property(e => e.Id).HasColumnName("Id");                                 // Project 4 added key on table
