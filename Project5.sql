...
AS
	...
	END CATCH
GO
GRANT EXECUTE ON sp_ins_disk TO diskUserLM;
GO
...
WHERE disk_id = @disk_id;
	...
	END CATCH
GO
GRANT EXECUTE ON sp_upd_disk TO diskUserLM;
GO
EXEC sp_upd_disk 21, 'Superunknown2', '3/3/1994', 4, 1, 1;
GO
EXEC sp_upd_disk 22, 'Superunknown3', '3/3/1994', 4, 1, NULL;
GO
...
AS
	...
	END CATCH
GO
GRANT EXECUTE ON sp_del_disk TO diskUserLM;
GO
EXEC sp_del_disk 21;
GO
EXEC sp_del_disk 22;
