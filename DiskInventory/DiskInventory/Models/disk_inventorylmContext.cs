...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                //optionsBuilder.UseSqlServer("Server=.\\SQLDEV01;Database=disk_inventorylm;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DiskHasArtist>(entity =>
            {
                entity.HasKey(e => new { e.DiskId, e.ArtistId })
                    .HasName("PK__disk_has__2DAE42F0F4AD705D");
            ...
            modelBuilder.Entity<DiskHasBorrower>(entity =>
            {
                entity.HasKey(e => new { e.BorrowerId, e.DiskId })
                    .HasName("PK__disk_has__EE13A606362DE85B");
